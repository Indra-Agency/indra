...
export function CenterCard() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-palladian/[0.03] blur-2xl rounded-[2.5rem] pointer-events-none" />
      
      {/* Actual Card */}
      <div
        className="relative w-full rounded-[2.5rem] p-6 flex flex-col items-center"
        style={{
          background: 'linear-gradient(180deg, var(--color-blue-fantastic) 0%, var(--color-abyssal-blue) 100%)',
          border: '1px solid rgba(201, 193, 177, 0.08)',
          boxShadow: '0 25px 50px -12px rgba(0,0,0,0.5), inset 0 1px 0 rgba(201,193,177,0.05)',
        }}
      >
      {/* ── Top Bar: Stars & Availability ── */}
      <div className="w-full flex justify-between items-center mb-8 px-2">
        <div className="flex gap-1 text-burning-flame">
          {[...Array(5)].map((_, i) => (
      ...
      <div className="relative w-48 h-48 mb-8 flex items-center justify-center">
        ...
        >
          ...
          <div className="absolute bottom-16 left-1/2 -translate-x-1/2 w-32 h-32 rounded-2xl border border-purple-500/40 bg-purple-500/10 transform rotate-45 scale-y-50 skew-x-12 flex items-center justify-center">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-palladian -rotate-45 scale-y-200 -skew-x-12">
