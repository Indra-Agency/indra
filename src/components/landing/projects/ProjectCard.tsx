...
export function ProjectCard({ project, index }: Props) {
  return (
    <motion.div
      ...
      className="group block rounded-3xl overflow-hidden bg-blue-fantastic border border-blue-fantastic transition-all duration-500 hover:-translate-y-2 hover:border-zinc-700 hover:shadow-2xl hover:shadow-abyssal-blue/50"
    >
      <div className="grid md:grid-cols-2">
        <div className="p-10 md:p-16 flex flex-col justify-center">
          <span className="text-zinc-500 text-sm font-semibold mb-4">{project.tag}</span>
          <h3 className="text-2xl font-bold text-palladian mb-6">{project.title}</h3>
          <p className="text-zinc-400 leading-relaxed text-base font-light mb-8">{project.desc}</p>
          
          <div className="mt-auto flex items-center gap-2 text-palladian font-medium group-hover:text-zinc-300 transition-colors">
        ...
        {/* Visual Placeholder */}
        <div className="bg-zinc-950 aspect-video md:aspect-auto border-s border-blue-fantastic relative overflow-hidden">
